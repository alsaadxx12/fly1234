    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-xl font-bold transition-all ${loadingGroups
          ...
          <div className="p-6 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${settings.exchangeRate.enabled ? 'bg-green-500' : 'bg-gray-300'
                  }`}
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${settings.exchangeRate.enabled ? 'translate-x-6' : 'translate-x-1'
                    }`}
                />
              </button>
            </div>
            ...
            <div>
              ...
              <button
                ...
                className={`w-full px-4 py-3 rounded-xl border-2 transition-all text-right flex items-center justify-between group ${theme === 'dark'
                  ...
                  } outline-none ${!settings.exchangeRate.enabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'
                  }`}
              >
                <span className={settings.exchangeRate.groupName ? '' : 'opacity-60'}>
                  {settings.exchangeRate.groupName || 'اختر مجموعة...'}
                </span>
                <ChevronLeft className={`w-5 h-5 transition-transform ${settings.exchangeRate.enabled ? 'group-hover:translate-x-1' : ''
                  }`} />
              </button>
            </div>
            ...
            {settings.exchangeRate.groupName && (
              <div className={`p-3 rounded-xl ${theme === 'dark' ? 'bg-green-900/20' : 'bg-green-50'
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className={`font-bold ${theme === 'dark' ? 'text-green-300' : 'text-green-700'
                    }`}>
          ...
          <div className="p-6 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${settings.apiBalance.enabled ? 'bg-blue-500' : 'bg-gray-300'
                  }`}
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${settings.apiBalance.enabled ? 'translate-x-6' : 'translate-x-1'
                    }`}
                />
              </button>
            </div>
            ...
            <div>
              ...
              <button
                ...
                className={`w-full px-4 py-3 rounded-xl border-2 transition-all text-right flex items-center justify-between group ${theme === 'dark'
                  ...
                  } outline-none ${!settings.apiBalance.enabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'
                  }`}
              >
                ...
                <ChevronLeft className={`w-5 h-5 transition-transform ${settings.apiBalance.enabled ? 'group-hover:translate-x-1' : ''
                  }`} />
              </button>
            </div>
            ...
            {settings.apiBalance.contactName && (
              <div className={`p-3 rounded-xl ${theme === 'dark' ? 'bg-blue-900/20' : 'bg-blue-50'
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className={`font-bold ${theme === 'dark' ? 'text-blue-300' : 'text-blue-700'
                    }`}>
          ...
          <div className="p-6 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${settings.topEmployees.enabled ? 'bg-yellow-500' : 'bg-gray-300'
                  }`}
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${settings.topEmployees.enabled ? 'translate-x-6' : 'translate-x-1'
                    }`}
                />
              </button>
            </div>
            ...
            <div>
              ...
              <button
                ...
                className={`w-full px-4 py-3 rounded-xl border-2 transition-all text-right flex items-center justify-between group ${theme === 'dark'
                  ...
                  } outline-none ${!settings.topEmployees.enabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'
                  }`}
              >
                <span className={settings.topEmployees.groupName ? '' : 'opacity-60'}>
                  {settings.topEmployees.groupName || 'اختر مجموعة...'}
                </span>
                <ChevronLeft className={`w-5 h-5 transition-transform ${settings.topEmployees.enabled ? 'group-hover:translate-x-1' : ''
                  }`} />
              </button>
            </div>

            <div className={`p-4 rounded-xl border-2 ${theme === 'dark' ? 'bg-yellow-900/10 border-yellow-800/30' : 'bg-yellow-50 border-yellow-200'
              }`}>
              <div className="flex items-start gap-3">
                <AlertTriangle className={`w-5 h-5 mt-0.5 ${theme === 'dark' ? 'text-yellow-400' : 'text-yellow-600'
                  }`} />
                <div>
                  <p className={`text-sm font-bold mb-1 ${theme === 'dark' ? 'text-yellow-300' : 'text-yellow-900'
                    }`}>
                    الإرسال مرة واحدة شهرياً
                  </p>
                  <p className={`text-xs ${theme === 'dark' ? 'text-yellow-200/80' : 'text-yellow-800'
                    }`}>
            ...
            {settings.topEmployees.lastSentMonth && (
              <div className={`p-3 rounded-xl ${theme === 'dark' ? 'bg-gray-900/50' : 'bg-gray-100'
                }`}>
          ...
          <div className="p-6 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${settings.unauditedTickets.enabled ? 'bg-red-500' : 'bg-gray-300'
                  }`}
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${settings.unauditedTickets.enabled ? 'translate-x-6' : 'translate-x-1'
                    }`}
                />
              </button>
            </div>
            ...
            <div>
              ...
              <button
                ...
                className={`w-full px-4 py-3 rounded-xl border-2 transition-all text-right flex items-center justify-between group ${theme === 'dark'
                  ...
                  } outline-none ${!settings.unauditedTickets.enabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'
                  }`}
              >
                <span className={settings.unauditedTickets.groupName ? '' : 'opacity-60'}>
                  {settings.unauditedTickets.groupName || 'اختر مجموعة...'}
                </span>
                <ChevronLeft className={`w-5 h-5 transition-transform ${settings.unauditedTickets.enabled ? 'group-hover:translate-x-1' : ''
                  }`} />
              </button>
            </div>

            <div className={`p-4 rounded-xl border-2 ${theme === 'dark' ? 'bg-red-900/10 border-red-800/30' : 'bg-red-50 border-red-200'
              }`}>
              <div className="flex items-start gap-3">
                <Calendar className={`w-5 h-5 mt-0.5 ${theme === 'dark' ? 'text-red-400' : 'text-red-600'
                  }`} />
                <div>
                  <p className={`text-sm font-bold mb-1 ${theme === 'dark' ? 'text-red-300' : 'text-red-900'
                    }`}>
                    تنبيه شهري
                  </p>
                  <p className={`text-xs ${theme === 'dark' ? 'text-red-200/80' : 'text-red-800'
                    }`}>
      ...
      <div className={`rounded-2xl shadow-lg p-6 ${theme === 'dark' ? 'bg-gray-800' : 'bg-white'
        ...
        <div className="flex items-center gap-3 mb-4">
          <Settings className={`w-6 h-6 ${theme === 'dark' ? 'text-blue-400' : 'text-blue-600'
            }`} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className={`p-4 rounded-xl ${settings.exchangeRate.enabled
            ...
            <div className="flex items-center gap-2 mb-2">
              <DollarSign className={`w-5 h-5 ${settings.exchangeRate.enabled
                  ? theme === 'dark' ? 'text-green-400' : 'text-green-600'
                  : theme === 'dark' ? 'text-gray-500' : 'text-gray-400'
                }`} />
              <span className={`font-bold text-sm ${settings.exchangeRate.enabled
          ...
          <div className={`p-4 rounded-xl ${settings.apiBalance.enabled
              ? theme === 'dark' ? 'bg-blue-900/20 border-2 border-blue-600' : 'bg-blue-50 border-2 border-blue-400'
              : theme === 'dark' ? 'bg-gray-900/50' : 'bg-gray-100'
            }`}>
            <div className="flex items-center gap-2 mb-2">
              <Wallet className={`w-5 h-5 ${settings.apiBalance.enabled
                  ? theme === 'dark' ? 'text-blue-400' : 'text-blue-600'
                  : theme === 'dark' ? 'text-gray-500' : 'text-gray-400'
                }`} />
              <span className={`font-bold text-sm ${settings.apiBalance.enabled
          ...
          <div className={`p-4 rounded-xl ${settings.topEmployees.enabled
              ? theme === 'dark' ? 'bg-yellow-900/20 border-2 border-yellow-600' : 'bg-yellow-50 border-2 border-yellow-400'
              : theme === 'dark' ? 'bg-gray-900/50' : 'bg-gray-100'
            }`}>
            <div className="flex items-center gap-2 mb-2">
              <Trophy className={`w-5 h-5 ${settings.topEmployees.enabled
                  ? theme === 'dark' ? 'text-yellow-400' : 'text-yellow-600'
                  : theme === 'dark' ? 'text-gray-500' : 'text-gray-400'
                }`} />
              <span className={`font-bold text-sm ${settings.topEmployees.enabled
          ...
          <div className={`p-4 rounded-xl ${settings.unauditedTickets.enabled
              ? theme === 'dark' ? 'bg-red-900/20 border-2 border-red-600' : 'bg-red-50 border-2 border-red-400'
              : theme === 'dark' ? 'bg-gray-900/50' : 'bg-gray-100'
            }`}>
            <div className="flex items-center gap-2 mb-2">
              <AlertTriangle className={`w-5 h-5 ${settings.unauditedTickets.enabled
                  ? theme === 'dark' ? 'text-red-400' : 'text-red-600'
                  : theme === 'dark' ? 'text-gray-500' : 'text-gray-400'
                }`} />
              <span className={`font-bold text-sm ${settings.unauditedTickets.enabled
