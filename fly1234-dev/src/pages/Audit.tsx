    ...
    <div className="p-6 max-w-[1600px] mx-auto">
      ...
      <div className={`mb-4 flex gap-3 ${
        ...
        <div className="flex-1 relative employee-search-container">
          <div className={`relative rounded-xl border ${
            ...
            <input
              ...
              className={`w-full px-3 py-3 pr-10 rounded-xl font-bold text-sm ${
                theme === 'dark'
            ...
            {(employeeSearchTerm || selectedEmployeeId) && (
              <button
                ...
                className={`absolute left-3 top-1/2 -translate-y-1/2 p-1 rounded-lg hover:bg-gray-700/50 transition-colors ${
          ...
          {showEmployeeSuggestions && (employeeSuggestions.length > 0 || employeesWithTickets.length > 0) && (
            <div className={`absolute z-50 w-full mt-2 rounded-xl border shadow-xl overflow-hidden ${
              theme === 'dark'
                    ...
                    {employeeSuggestions.map(employee => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full px-4 py-3 text-right hover:bg-opacity-50 transition-colors border-b last:border-b-0 ${
                            theme === 'dark'
        ...
        <button
          ...
          className={`px-5 py-3 rounded-xl border font-bold text-sm transition-all flex items-center gap-2 ${
            showFilters
              ? theme === 'dark'
      ...
      {/* Tabs */}
      <div className={`flex gap-2 mb-4 p-1 rounded-xl border ${
        theme === 'dark'
          ? 'bg-gray-800/50 border-gray-700'
        ...
        <button
          ...
          className={`flex-1 px-4 py-2 rounded-lg font-bold transition-all duration-200 flex items-center justify-center gap-2 text-sm ${
            activeTab === 'entry'
              ? theme === 'dark'
      ...
      {/* Filters - Collapsible */}
      {showFilters && (
        <div className={`mb-4 p-4 rounded-xl border animate-in slide-in-from-top-2 duration-200 ${
          theme === 'dark'
            ? 'bg-gray-800/50 border-gray-700'
            : 'bg-white border-gray-200'
        }`}>
