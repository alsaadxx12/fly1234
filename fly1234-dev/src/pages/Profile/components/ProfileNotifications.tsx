...
import { Bell, Coins, DollarSign, Cpu, TrendingUp, Clock, Megaphone, ShieldAlert, CreditCard, Send, Plus, Sparkles } from 'lucide-react';
...
export default function ProfileNotifications() {
    ...
    const isAdmin = checkPermission('settings', 'isAdmin') || checkPermission('accounts', 'confirm'); // Fallback check or isAdmin
