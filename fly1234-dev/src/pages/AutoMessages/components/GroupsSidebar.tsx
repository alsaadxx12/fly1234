...
import { X, Search, Users, Check, ChevronLeft } from 'lucide-react';
                            ...
                            {filteredGroups.length > 0 ? (
                                filteredGroups.map((group) => (
                                    <button
                                        ...
                                        className={`w-full flex items-center justify-between p-4 rounded-2xl border transition-all hover:scale-[1.02] ${selectedGroupId === group.id
                                            ? theme === 'dark'
                                    ...
                                    >
                                        ...
                                        <span className="font-bold flex-1 text-right">{group.name}</span>
                                    </button>
                                ))
                            ) : (
                                <div className="py-12 text-center opacity-50">
                                    <Users className="w-12 h-12 mx-auto mb-3 opacity-20" />
                                    <p className="font-bold">لا توجد مجموعات مطابقة</p>
                                </div>
                            )}
                        </div>
                    </motion.div>
