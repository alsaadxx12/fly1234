...
import { Repeat, Plus, Search, Filter, Calendar, CheckCircle2, AlertTriangle, Clock } from 'lucide-react';
...
const SubscriptionsHeader: React.FC<SubscriptionsHeaderProps> = ({
  setIsAddModalOpen,
  searchQuery,
  setSearchQuery,
  filterStatus,
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="p-3 bg-secondary-50 rounded-xl">
            <Repeat className="w-6 h-6 text-secondary-800" />
          </div>
          <div>
            <h2 className="text-xl font-bold text-secondary-800">قائمة الاشتراكات</h2>
            <p className="text-sm text-gray-600 mt-1">إجمالي {totalSubscriptions} اشتراك</p>
          </div>
        </div>
