  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gradient-to-br dark:from-[#1a1d29] dark:via-[#1f2937] dark:to-[#111827] flex flex-col transition-colors duration-200 text-right h-screen overflow-hidden">
      ...
      >
        ...
        <div className="relative flex items-center justify-between px-3 md:px-6 h-14 md:h-[60px] text-white">
          {/* Left Side - User Menu */}
                  ...
                  <div className="absolute right-0 mt-2 w-72 bg-white dark:bg-[#1f2937] rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700/50 z-50 overflow-hidden animate-in fade-in-5 slide-in-from-top-2 duration-200 backdrop-blur-xl">
                    ...
                    <div className="p-2 border-t border-gray-200 dark:border-gray-700/50">
                      ...
                      <Link
                        ...
                        onClick={() => setIsUserMenuOpen(false)}
                      >
                        <Settings className="w-4 h-4 text-gray-500 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" />
                        <span>الإعدادات</span>
                      </Link>
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="relative flex items-center justify-center px-5 py-2 bg-white/[0.08] backdrop-blur-xl rounded-2xl border border-white/[0.12] shadow-lg hover:bg-white/[0.12] transition-all duration-500 group min-w-[90px] hover-lift">
              {/* Decorative gradient overlay */}
              <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/0 via-indigo-500/[0.06] to-purple-500/0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

              {/* Rate value */}
              <span className="relative z-10 text-base md:text-lg font-black text-white drop-shadow-sm leading-none tracking-wide">
            ...
            <div className="flex items-center group">
              {customSettings.logoUrl && (
                <img
                  ...
                  alt="Logo"
                  className="h-8 md:h-10 w-auto object-contain transition-all duration-500 group-hover:scale-105 drop-shadow-[0_0_12px_rgba(255,255,255,0.15)]"
